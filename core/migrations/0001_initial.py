# Generated by Django 4.2.7 on 2025-10-18 00:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_adquisicion', models.DateField(blank=True, null=True, verbose_name='Fecha de Alta')),
                ...
                ('valor_adquisicion', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Precio')),
                ('servicios', models.CharField(blank=True, max_length=200, verbose_name='Servicios')),
                ('observaciones', models.TextField(blank=True, verbose_name='Observaciones')),
                ('fecha_baja', models.DateField(blank=True, null=True, verbose_name='Fecha de Baja')),
                ('expediente_baja', models.CharField(blank=True, max_length=100, null=True, verbose_name='Expediente Baja')),
                ('descripcion_baja', models.TextField(blank=True, verbose_name='Descripción de baja')),
