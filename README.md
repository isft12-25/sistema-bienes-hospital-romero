# 馃彞 Sistema de Gesti贸n de Bienes Patrimoniales - Hospital Melchor Romero

## 馃搵 Descripci贸n
Sistema web desarrollado en Django para la gesti贸n y control de bienes patrimoniales del Hospital Melchor Romero.

## 馃殌 Caracter铆sticas
- Registro y catalogaci贸n de bienes patrimoniales
- Control de inventario en tiempo real
- Gesti贸n de mantenimientos y estados
- Informes y reportes personalizados
- M煤ltiples ambientes (Desarrollo, Producci贸n)
...
# ??? INSTRUCTIVOS COMPLETOS - Sistema de Gestión de Bienes Patrimoniales
...
git add .
git commit -m "feat(frontend): dise?ar interfaz de inventario"
